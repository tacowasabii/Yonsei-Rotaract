const navItems = [
  { icon: "campaign", label: "소식", active: true },
  { icon: "forum", label: "게시판", active: false },
  { icon: "school", label: "선배님", active: false },
  { icon: "notifications", label: "공지", active: false },
  { icon: "photo_library", label: "사진첩", active: false },
];
