...
export function PasswordField({ label, placeholder, hasError, errorMessage, inputProps }: Props) {
    ...
    <div>
      ...
      <div
        className={`flex items-center bg-surface-container rounded-xl px-3.5 transition-all ${
          hasError ? "ring-2 ring-error" : "focus-within:ring-2 focus-within:ring-primary-container/30"
        }`}
      >
