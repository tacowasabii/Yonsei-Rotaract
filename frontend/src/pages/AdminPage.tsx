      ...
      <header className="mb-8 flex items-center justify-between flex-wrap gap-4">
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-3xl font-extrabold text-on-surface tracking-tight font-headline">관리자 페이지</h1>
            <span className="text-xs font-bold bg-error/10 text-error px-2 py-0.5 rounded-full">ADMIN</span>
          </div>
          <p className="text-on-surface-variant text-sm">연세 로타랙트 커뮤니티 운영 관리 패널</p>
        </div>
      </header>
